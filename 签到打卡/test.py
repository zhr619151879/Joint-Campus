...
# 人脸数据文件
PATH_FACE = "/Users/zhuhaoran/Documents/GitHub/WorkAttendanceSystem/V2.0/data/face_img_database/"

# 提取人脸
detector = dlib.get_frontal_face_detector()
predictor = dlib.shape_predictor(
    '/Users/zhuhaoran/Documents/GitHub/WorkAttendanceSystem/V2.0/model/shape_predictor_68_face_landmarks.dat')

# face recognition model, the object maps human faces into 128D vectors
facerec = dlib.face_recognition_model_v1(
    "/Users/zhuhaoran/Documents/GitHub/WorkAttendanceSystem/V2.0/model/dlib_face_recognition_resnet_model_v1.dat")
...
class WAS(wx.Frame):
    ...
    def initMenu(self):
        ...
        self.new_register.SetBitmap(
            wx.Bitmap("/Users/zhuhaoran/Documents/GitHub/WorkAttendanceSystem/V2.0/drawable/new_register.png"))
        ...
        self.finish_register.SetBitmap(
            wx.Bitmap("/Users/zhuhaoran/Documents/GitHub/WorkAttendanceSystem/V2.0/drawable/finish_register.png"))
        ...
        self.start_punchcard.SetBitmap(
            wx.Bitmap("/Users/zhuhaoran/Documents/GitHub/WorkAttendanceSystem/V2.0/drawable/start_punchcard.png"))
        ...
        self.end_puncard.SetBitmap(
            wx.Bitmap("/Users/zhuhaoran/Documents/GitHub/WorkAttendanceSystem/V2.0/drawable/end_puncard.png"))
        ...
        self.open_logcat.SetBitmap(
            wx.Bitmap("/Users/zhuhaoran/Documents/GitHub/WorkAttendanceSystem/V2.0/drawable/open_logcat.png"))
        ...
        self.close_logcat.SetBitmap(
            wx.Bitmap("/Users/zhuhaoran/Documents/GitHub/WorkAttendanceSystem/V2.0/drawable/close_logcat.png"))
    ...
    def ifLoginValid(self):
        ...
        def on_but_login(event):
            ...
            if user_name == acc and pass_word == str(pwd):
                show_message('登录成功')
                frame.Destroy()
                self.frame1 = managerWin.ManagerWin()
    ...
    def OnOpenLogcatClicked(self, event):
        ...
        # 加载数据库
        self.loadDataBase(2)  # 用一个列表返回数据库 不要赋值给self (data = xx.loadDataBase() )
        # 必须要变宽才能显示 scroll
        ...
        for i, id in enumerate(self.logcat_id):
            ...
            grid.SetCellTextColour(i, 3, wx.RED) if self.logcat_late[i] == '是' else grid.SetCellTextColour(i, 3,
                                                                                                           wx.GREEN)
        # Not allowed to edit
        ...
        while self.cap.isOpened():
            ...
            if len(dets) != 0:
                ...
                for i, knew_face_feature in enumerate(self.knew_face_feature):
                    ...
                    compare = return_euclidean_distance(features_cap, knew_face_feature)
                    if compare == "same":  # 找到了相似脸
                        cv2.putText(im_rd, self.knew_name[i], (biggest_face.left(), biggest_face.top() - 7), font, 1,
                                    (255, 0, 0))
                        cv2.imshow('recognizing...', im_rd)
                        cv2.waitKey(2000)
                        print("same")
                        ...
                        for j, logcat_name in enumerate(self.logcat_name):
                            ...
                            print(self.logcat_datetime[j][1:self.logcat_datetime[j].index(" ")])
                            if logcat_name == self.knew_name[i] and nowdt[1:nowdt.index(" ")] == self.logcat_datetime[
                                                                                                     j][
                                                                                                 1:self.logcat_datetime[
                                                                                                     j].index(" ")]:
                                print('yese!')
    ...
    def initInfoText(self):
        ...
        self.infoText.AppendText(self.info)
        font = wx.Font()
    ...
    def initGallery(self):
        self.pic_index = wx.Image("/Users/zhuhaoran/Documents/GitHub/WorkAttendanceSystem/V2.0/drawable/index.png",
    ...
    def initDatabase(self):
        conn = sqlite3.connect(
            "/Users/zhuhaoran/Documents/GitHub/WorkAttendanceSystem/V2.0/data/inspurer.db")  # 建立数据库连接
